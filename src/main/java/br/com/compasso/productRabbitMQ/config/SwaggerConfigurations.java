package br.com.compasso.productRabbitMQ.config;
...
public class SwaggerConfigurations {
	@Bean
	public Docket api() {
		Predicate<RequestHandler> basePackage = RequestHandlerSelectors.basePackage("br.com.compasso.productRabbitMQ");
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Api de Catálogo de produtos com HabbitMQ ")
